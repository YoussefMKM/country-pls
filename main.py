...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.flag_img.setFocusPolicy(QtCore.Qt.NoFocus)
        self.flag_img.setStyleSheet("border-color: rgb(0, 0, 0);")
        self.flag_img.setFrameShadow(QtWidgets.QFrame.Plain)
        self.flag_img.setLineWidth(2)
        ...
        self.official_name_6 = QtWidgets.QLabel(self.groupBox_2)
        self.official_name_6.setObjectName("official_name_6")
        self.gridLayout.addWidget(self.official_name_6, 3, 1, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.official_name.setText(_translate("MainWindow", ""))
        self.label_5.setText(_translate("MainWindow", "Capital:"))
        self.capital.setText(_translate("MainWindow", ""))
        self.label_6.setText(_translate("MainWindow", "Continent"))
        self.region.setText(_translate("MainWindow", ""))
        self.label_4.setText(_translate("MainWindow", "Country Code:"))
        self.callingCode.setText(_translate("MainWindow", ""))
        self.pushButton.setText(_translate("MainWindow", "Search"))
        self.flag_img.setToolTip(_translate("MainWindow", "Flag"))
        self.flag_img.setText(_translate("MainWindow", ""))
        self.groupBox_2.setTitle(_translate("MainWindow", "Detailed Informations"))
        self.label_7.setText(_translate("MainWindow", "Population:"))
        self.population.setText(_translate("MainWindow", ""))
        self.label_8.setText(_translate("MainWindow", "Surface Area"))
        self.area.setText(_translate("MainWindow", ""))
        self.label_9.setText(_translate("MainWindow", "Timezone"))
        self.timezones.setText(_translate("MainWindow", ""))
        self.label_10.setText(_translate("MainWindow", "Gini Coeficient"))
        self.official_name_6.setText(_translate("MainWindow", ""))
